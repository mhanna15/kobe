...
const syntaxChecks = [
  ...
  ["multiple statements", "baal job shoot(num a) { } reps(5) {shoot(5)}"],
  ["variable declarations", 'baal e = true num x = 0 quote spaget = "pasta"'],
  ["function with no params, no return type", " void job banana() {}"],
  ...
  ["function with two params", "baal job f(num x, baal y) {}"],
  ["function with no params + return type", "void job f() {}"],
  ...
  [
    "longer if",
    "baal hello = true if (hello) { print(1) } elif (x == 1) { print(1) }",
  ],
...
const syntaxErrors = [
  ...
  // ["missing curly brace", "num job f() {", /Line 1, col 10/],
